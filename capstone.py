def main_menu ():
    print("Selamat Datang di Gudang Lumajang Agro Lestari")
    print("Main Menu :")
...
def menu_read():
    ...
    if program_read == 1:
        ...
        menu_sort(data_gudang)
    elif program_read == 5:
        cari = input("Masukkan kode barang yang ingin dicari :")
        cari = list(filter(lambda kode: kode['FK'] == cari, data_gudang))
        if cari == []:
...
def menu_sort(data_gudang):
    print("Urutkan Data berdasarkan Kolom :")
    print("1. Kode Barang")
    print("2. Nama Barang")
    ...
    urut = []
    if program_sort == 1:
        urut = sorted(data_gudang, key=lambda d: d['FK'])
        read(urut)
    elif program_sort == 2:
...
def create(code):
        ...
        if cari != []:
            ...
            data_masuk = {"ID" : masuk,"FK":kode_barang,"Nama":nama_barang,"Tanggal Masuk":tanggal,"Jumlah" : jumlah,"Satuan" : satuan}
            data_gudang.append(data_masuk)
            read(data_gudang)
            menu_create()
...
data_gudang = [
    {"ID" : "K01","FK":"PD01","Nama":"Sirup Telang","Tanggal Masuk":"04-02-24","Jumlah" : 20,"Satuan" : "Botol"},
    {"ID" : "K02","FK":"PD02","Nama":"Sirup Lemon","Tanggal Masuk":"05-02-24","Jumlah" : 20,"Satuan" : "Botol"},
    {"ID" : "K03","FK":"PD03","Nama":"Keripik Tempe Sagu","Tanggal Masuk":"06-02-24","Jumlah" : 50,"Satuan" : "Pcs"},
    {"ID" : "M01","FK":"BM01","Nama":"Lemon","Tanggal Masuk":"31-01-24","Jumlah" : 10,"Satuan" : "KG"},
    {"ID" : "M02","FK":"BM02","Nama":"Bunga Telang","Tanggal Masuk":"31-01-24","Jumlah" : 2,"Satuan" : "KG"},
    {"ID" : "M03","FK":"BB01","Nama":"Botol Plastik","Tanggal Masuk":"08-02-24","Jumlah" : 40,"Satuan" : "Buah"}
]

data_hapus = [
    {"ID" : "K04","FK":"PD04","Nama":" Air Lemon Sereh","Tanggal Masuk":"10-02-24","Jumlah" : 40,"Satuan" : "Botol"},
    {"ID" : "M04","FK":"BB02","Nama":"Batang Serai","Tanggal Masuk":"09-02-24","Jumlah" : 5,"Satuan" : "KG"}
]
